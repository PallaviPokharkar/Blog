  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"><span class="	fa fa-bell-o"></span> Prashant Sail <span class="sr-only">(current)</span></a>
      </li>
<!--       <li class="nav-item"> -->
...
<!--       </li> -->
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link " href="login_page.jsp"><span class="fa fa-user-circle fa"></span> Login</a>
      </li>
      <li class="nav-item">
